...
* INDICADOR: Porcentaje de personas que preciben pensiones  por debajo de la línea de pobreza
* CÓDIGO:    335
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 335                  // Código de indicador
	...
	replace pensiones_insuf_lp=1 if pensiones<lp06_individual

	
    mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0 & region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0 & bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	6
	foreach val of numlist 1/2  {
	mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0 & bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pensiones_insuf_lp [aw=bc_pesoan] if pensiones>0 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 335
g NOMINDICADOR           = "PORCENTAJE DE PERSONAS QUE PERCIBEN JUBILACIONES POR DEBAJO DE LA LÍNEA DE POBREZA"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PORCENTAJE DE PERSONAS EN HOGARES NO EN SITUACIÓN DE POBREZA QUE PERCIBEN PENSONES POR DEBAJO DE LA LÍNEA DE POBREZA"    if AUXILIAR==13
replace NOMINDICADOR    = "PORCENTAJE DE PERSONAS EN HOGARES EN SITUACIÓN DE POBREZA QUE PERCIBEN PENSONES POR DEBAJO DE LA LÍNEA DE POBREZA"       if AUXILIAR==14
