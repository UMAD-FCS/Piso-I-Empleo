...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 313                  // Código de indicador
	...
	g desempleo=.
	replace desempleo = 1 if bc_pobp>=3 & bc_pobp<=5
	replace desempleo = 0 if bc_pobp==2
	
	mean desempleo [aw=bc_pesoan]
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean desempleo [aw=bc_pesoan] if region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean desempleo [aw=bc_pesoan] if bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean desempleo [aw=bc_pesoan] if tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	10
	foreach val of numlist 1/2  {
	mean desempleo [aw=bc_pesoan] if bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	12
	foreach val of numlist 1/5  {
	mean desempleo [aw=bc_pesoan] if bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean desempleo [aw=bc_pesoan] if pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 313
g NOMINDICADOR           = "TASA DE DESEMPLEO"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 14 A 18 AÑOS"  if AUXILIAR==5
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 19 A 24 AÑOS"  if AUXILIAR==6
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 25 A 29 AÑOS"  if AUXILIAR==7
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 30 A 64 AÑOS"  if AUXILIAR==8
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 65 AÑOS Y MÁS" if AUXILIAR==9
...
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS EN HOGARES NO EN SITUACIÓN DE POBREZA"    if AUXILIAR==17
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS EN HOGARES EN SITUACIÓN DE POBREZA"       if AUXILIAR==18
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	mean desempleo [aw=bc_pesoan] if bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
	...
	local j  = 	1
	foreach val of numlist 1/2  { 
	mean desempleo [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	3
	foreach val of numlist 1/5  {
	mean desempleo [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	8
	foreach val of numlist 1/5  {
	mean desempleo [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 14 A 18 AÑOS"  if AUXILIAR==3
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 19 A 24 AÑOS"  if AUXILIAR==4
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 25 A 29 AÑOS"  if AUXILIAR==5
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 30 A 64 AÑOS"  if AUXILIAR==6
replace NOMINDICADOR    = "TASA DE DESEMPLEO DE PERSONAS DE 65 AÑOS Y MÁS" if AUXILIAR==7
