...
* INDICADOR: Salario promedio por hora de trabajo remunerado en ocupación princial
* CÓDIGO:    321
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 321                  // Código de indicador
    ...
    mean yhoradef [aw=bc_pesoan] if bc_pobp==2
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	10
	foreach val of numlist 1/2  {
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	12
	foreach val of numlist 1/5  {
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 321
g NOMINDICADOR           = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL (DEF. BASE 2010)"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 14 A 18 AÑOS (DEF. BASE 2010)"  if AUXILIAR==5
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 19 A 24 AÑOS (DEF. BASE 2010)"  if AUXILIAR==6
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 25 A 29 AÑOS (DEF. BASE 2010)"  if AUXILIAR==7
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 30 A 64 AÑOS (DEF. BASE 2010)"  if AUXILIAR==8
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 65 AÑOS Y MÁS (DEF. BASE 2010)" if AUXILIAR==9
...
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS EN HOGARES NO EN SITUACIÓN DE POBREZA (DEF. BASE 2010)"    if AUXILIAR==17
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS EN HOGARES EN SITUACIÓN DE POBREZA (DEF. BASE 2010)"       if AUXILIAR==18
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
	...
	local j  = 	1
	foreach val of numlist 1/2  { 
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bc_pe2==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	3
	foreach val of numlist 1/5  {
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & tramo_edad==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	8
	foreach val of numlist 1/5  {
	mean yhoradef [aw=bc_pesoan] if bc_pobp==2 & bd_quintilesy==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 14 A 18 AÑOS (DEF. BASE 2010)"  if AUXILIAR==3
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 19 A 24 AÑOS (DEF. BASE 2010)"  if AUXILIAR==4
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 25 A 29 AÑOS (DEF. BASE 2010)"  if AUXILIAR==5
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 30 A 64 AÑOS (DEF. BASE 2010)"  if AUXILIAR==6
replace NOMINDICADOR    = "INGRESO POR HORA PROMEDIO EN OCUPACIÓN PRINCIPAL DE PERSONAS DE 65 AÑOS Y MÁS (DEF. BASE 2010)" if AUXILIAR==7
