...
*======================================================================================*
	...
	global seieTOT 15/19         // Años de serie para total país
...
* INDICADOR: Porcentaje de hogares que perciben Tarjetas Uruguay Social
* CÓDIGO:    341
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 341                 // Código de indicador
	local grupo  = 13                   // Cantidad de grupos
	local canio  = 5                   // Cantidad de años de la serie
	...
	g tus2 = 0
	replace tus2 = 1 if e560_1 == 1 | e560_2 ==1
	egen h_tus = max (tus2), by (bc_correlat)
    ...
    mean h_tus [aw=bc_pesoan] if bc_pe4==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean h_tus [aw=bc_pesoan] if bc_pe4==1 & region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean h_tus [aw=bc_pesoan] if bc_pe4==1 & sexojefe==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean h_tus [aw=bc_pesoan] if bc_pe4==1 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean h_tus [aw=bc_pesoan] if bc_pe4==1 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 341
g NOMINDICADOR           = "PORCENTAJE DE HOGARES QUE PERCIBEN TARJETA URUGUAY SOCIAL"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PORCENTAJE DE HOGARES CON JEFATURA MASCULINA QUE PERCIBEN TARJETA URUGUAY SOCIAL" if AUXILIAR==4
replace NOMINDICADOR    = "PORCENTAJE DE HOGARES CON JEFATURA FEMENINA QUE PERCIBEN TARJETA URUGUAY SOCIAL"  if AUXILIAR==5
...
replace NOMINDICADOR    = "PORCENTAJE DE HOGARES NO EN SITUACIÓN DE POBREZA QUE PERCIBEN TARJETA URUGUAY SOCIAL"    if AUXILIAR==11
replace NOMINDICADOR    = "PORCENTAJE DE HOGARES EN SITUACIÓN DE POBREZA QUE PERCIBEN TARJETA URUGUAY SOCIAL"       if AUXILIAR==12
