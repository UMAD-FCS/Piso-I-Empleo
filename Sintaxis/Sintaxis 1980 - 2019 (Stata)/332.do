...
* INDICADOR: Porcentaje de mayores de 65 años que perciben pensiones
* CÓDIGO:    332
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 332                  // Código de indicador
	...
	mean pension [aw=bc_pesoan] if bc_pe3>=65 
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean pension [aw=bc_pesoan] if bc_pe3>=65 & region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pension [aw=bc_pesoan] if bc_pe3>=65 & bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	5
	foreach val of numlist 1/2  {
	mean pension [aw=bc_pesoan] if bc_pe3>=65 & bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pension [aw=bc_pesoan] if bc_pe3>=65 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean pension [aw=bc_pesoan] if bc_pe3>=65 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 332
g NOMINDICADOR           = "PORCENTAJE DE MAYORES DE 65 AÑOS QUE PERCIBEN PENSIÓN"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PORCENTAJE DE MAYORES DE 65 AÑOS QUE PERCIBEN PENSIÓN EN HOGARES NO EN SITUACIÓN DE POBREZA"    if AUXILIAR==12
replace NOMINDICADOR    = "PORCENTAJE DE MAYORES DE 65 AÑOS QUE PERCIBEN PENSIÓN EN HOGARES EN SITUACIÓN DE POBREZA"       if AUXILIAR==13
