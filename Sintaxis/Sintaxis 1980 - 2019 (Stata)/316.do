...
*======================================================================================*
    ...
    global seieURB 91/99 0/19   // Años de serie para país urbano
...
* INDICADOR: Promedio de horas semanales trabajadas remuneradamente
* CÓDIGO:    316
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 316                  // Código de indicador
    ...
    mean bc_horas [aw=bc_pesoan] if bc_pobp==2
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	10
	foreach val of numlist 1/2  {
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	12
	foreach val of numlist 1/5  {
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 316
g NOMINDICADOR           = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 14 A 18 AÑOS"  if AUXILIAR==5
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 19 A 24 AÑOS"  if AUXILIAR==6
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 25 A 29 AÑOS"  if AUXILIAR==7
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 30 A 64 AÑOS"  if AUXILIAR==8
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 65 AÑOS Y MÁS" if AUXILIAR==9
...
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO SEMANALES REMUNERADAS DE PERSONAS EN HOGARES NO EN SITUACIÓN DE POBREZA"    if AUXILIAR==17
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO SEMANALES REMUNERADAS DE PERSONAS EN HOGARES EN SITUACIÓN DE POBREZA"       if AUXILIAR==18
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
	...
	local j  = 	1
	foreach val of numlist 1/2  { 
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bc_pe2==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	3
	foreach val of numlist 1/5  {
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & tramo_edad==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	8
	foreach val of numlist 1/5  {
	mean bc_horas [aw=bc_pesoan] if bc_pobp==2 & bd_quintilesy==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
**MODIFICACIÓN MANUAL: ACTUALIZAR LOCALS**
	...
	local canio  = 26                 // Cantidad de años de la serie
...
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 14 A 18 AÑOS"  if AUXILIAR==3
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 19 A 24 AÑOS"  if AUXILIAR==4
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 25 A 29 AÑOS"  if AUXILIAR==5
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 30 A 64 AÑOS"  if AUXILIAR==6
replace NOMINDICADOR    = "PROMEDIO DE HORAS SEMANALES DE TRABAJO REMUNERADAS DE PERSONAS DE 65 AÑOS Y MÁS" if AUXILIAR==7
...
append using "$tabulados\Auxiliares\\316_TP.dta", force
