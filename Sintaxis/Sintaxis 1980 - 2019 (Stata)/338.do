...
* INDICADOR: Porcentaje de desempleados que preciben seguro de desempleo
* CÓDIGO:    331
...
**MODIFICACIÓN MANUAL: CÓDIGOS Y LOCAL J PARA VARIABLES AUXILIARES**
    ...
    *TOTAL PAÍS
	local i      = 1
	local codind = 338                  // Código de indicador
	...
	g seguro2=0
	replace seguro2 = 1 if bc_pobp==5 
	replace seguro2 = . if bc_pobp!=4 & bc_pobp!=5
	
	mean seguro2 [aw=bc_pesoan]
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	...
	mean seguro2 [aw=bc_pesoan] if region_3==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
	matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean seguro2 [aw=bc_pesoan] if bc_pe2==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean seguro2 [aw=bc_pesoan] if tramo_edad==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	10
	foreach val of numlist 1/2  {
	mean seguro2 [aw=bc_pesoan] if bd_e29_1==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	12
	foreach val of numlist 1/5  {
	mean seguro2 [aw=bc_pesoan] if bd_quintilesy==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	mean seguro2 [aw=bc_pesoan] if pobre06==`val'
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
g CODIND                 = 338
g NOMINDICADOR           = "PORCENTAJE DE DESOCUPADOS QUE PERCIBEN SEGURO DE DESEMPLEO"
g SEXO                   = "NA"
g ASCENDENCIA    		 = "NA"
g QUINTIL       		 = "NA"
g DEPARTAMENTOUY		 = "NA"
...
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 14 A 18 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==5
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 19 A 24 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==6
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 25 A 29 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==7
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 30 A 64 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==8
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 65 AÑOS Y MÁS QUE PERCIBEN SEGURO DE DESEMPLEO" if AUXILIAR==9
...
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS QUE PERCIBEN SEGURO DE DESEMPLEO EN HOGARES NO EN SITUACIÓN DE POBREZA"    if AUXILIAR==17
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS QUE PERCIBEN SEGURO DE DESEMPLEO EN HOGARES EN SITUACIÓN DE POBREZA"       if AUXILIAR==18
...
************************************************************************************************
    ...
    *PAÍS URBANO
	...
	mean seguro2 [aw=bc_pesoan] if bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  0
	matrix MATR  [`i',3]=  `anio'
	...
	local j  = 	1
	foreach val of numlist 1/2  { 
	mean seguro2 [aw=bc_pesoan] if bc_pe2==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	3
	foreach val of numlist 1/5  {
	mean seguro2 [aw=bc_pesoan] if tramo_edad==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
    ...
    *
	...
	local j  = 	8
	foreach val of numlist 1/5  {
	mean seguro2 [aw=bc_pesoan] if bd_quintilesy==`val' & bc_filtloc==1
	matrix MATR  [`i',1]=  e(b)
	matrix MATR  [`i',2]=  `j'
    matrix MATR  [`i',3]=  `anio'
...
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 14 A 18 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==3
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 19 A 24 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==4
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 25 A 29 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==5
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 30 A 64 AÑOS QUE PERCIBEN SEGURO DE DESEMPLEO"  if AUXILIAR==6
replace NOMINDICADOR    = "PORCENTAJE DE DESOCUPADOS DE 65 AÑOS Y MÁS QUE PERCIBEN SEGURO DE DESEMPLEO" if AUXILIAR==7
